...
export default function MinuteBookClient() {
  ...
  // Entity scope = GlobalBar selection (with optional URL override for deep-links)
  const [entityKey, setEntityKey] = useState<string>(activeEntity);

  useEffect(() => {
    // Priority: URL entity_key override (no useSearchParams), else global entity.
    const fromUrl =
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
            <div className="min-w-0">
              ...
              <div className="mt-1 text-xs text-white/55">
                Domains → Entries → Details · Non-destructive · Preview on demand
              </div>
            </div>
                ...
                <div className="p-5">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
                    ...
                    <div className="mt-1 text-sm text-white/60">
                      No minute book entries exist for this entity yet. Upload is
    ...
    >
      ...
      <span
        className={cls(
          ...
          active
            ? "border border-yellow-500/20 bg-yellow-500/10 text-yellow-100/80"
